...
user_question = st.selectbox("Choose a question:", list(chatbot_questions_answers.keys()))
...
for chat in st.session_state['chat_history']:
    if chat['role'] == 'user':
        ...
        <div style="
            ...
            align-items: center;
        ">
            <img src="https://example.com/user_icon.png" alt="User" style="
                width: 30px;
                height: 30px;
                border-radius: 50%;
                margin-right: 10px;
        ...
        <div style="
            ...
            align-items: center;
        ">
            <img src="https://example.com/bot_icon.png" alt="Bot" style="
                width: 30px;
                height: 30px;
                border-radius: 50%;
                margin-right: 10px;
